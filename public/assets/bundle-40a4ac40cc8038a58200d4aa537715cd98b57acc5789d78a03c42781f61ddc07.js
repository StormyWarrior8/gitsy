...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dashboard = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RepoList = __webpack_require__(169);
	var Repo = __webpack_require__(170);
	var Readme = __webpack_require__(171);
	var AddTag = __webpack_require__(172);
	...
	var Dashboard = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    $.getJSON('/repos', function (response) {
	      _this.setState({ currentStarredRepos: response });
	    });
	  },
	  handleStar: function handleStar(id) {
	    var updatedRepos = this.state.currentStarredRepos.map(function (repo) {
	      if (repo.id === id) {
	  ...
	  handleRepo: function handleRepo(repo_id, clone_url, readme_url) {
	    this.setState({
	  ...
	  handleAddTag: function handleAddTag(text) {
	    ...
	    var updatedRepos = this.state.currentStarredRepos.map(function (repo) {
	      if (repo.id === _this2.state.selectedRepoId) {
	        var tagName = text;
	  ...
	  render: function render() {
	    ...
	    var showReadme = function showReadme(active) {
	      if (active == true) {
	        return React.createElement(Readme, { selectedRepoClone: selectedRepoCloneUrl, selectedRepoReadme: selectedRepoReadmeUrl, onAddTag: _this3.handleAddTag });
	      }
	    };
	    ...
	    return React.createElement(
	      ...
	      React.createElement(RepoList, { repos: currentStarredRepos, onStar: this.handleStar, onSelected: this.handleRepo }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RepoList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var renderRepos = function renderRepos() {
	      return repos.map(function (repo) {
	        return React.createElement(Repo, { key: repo.id, id: repo.id, name: repo.repo_name, description: repo.desc, language: repo.lang, htmlUrl: repo.html_url, cloneUrl: repo.clone_url, readmeUrl: repo.readme_url, stargazersCount: repo.stars, forksCount: repo.forks, watchersCount: repo.watchers, starLevel: repo.star_level, tag: repo.tag, onStar: _this.props.onStar, onSelected: _this.props.onSelected });
	      });
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Repo = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      "div",
	      { className: "ui vertical padded segment repo", onClick: function onClick() {
	          _this.props.onSelected(id, cloneUrl, readmeUrl);
	        } },
	      React.createElement(
	        "i",
	        { onClick: function onClick() {
	            _this.props.onStar(id);
	          } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Readme = React.createClass({
	  ...
	  renderReadme: function renderReadme(readme_url) {
	    axios.get(readme_url).then(function (response) {
	      ...
	      axios.get(readme_url_2).then(function (response) {
	        var data = response.data;
	        ...
	        axios.get(readme_url_3).then(function (response) {
	          var data = response.data;
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'ui very padded text container segment readme' },
	        this.renderReadme(selectedRepoReadme),
	        React.createElement(AddTag, { onAddTag: this.props.onAddTag }),
	        React.createElement(
	          'p',
	          null,
	          React.createElement(
	        ...
	        React.createElement('div', { className: 'readme-md' })
	      )
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', ref: 'tag', placeholder: 'Enter tag' }),
	        React.createElement(
	          'button',
	          { className: 'ui tag label', type: 'submit' },
	          ' Add Tag '
	        )
	      )
	    );
